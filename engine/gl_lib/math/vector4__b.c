...
{
	return (vec4_4f(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z, v1.w - v2.w));
}

t_vec4	mult4_scalar(t_vec4 v, float scalar)
{
	return (vec4_4f(v.x * scalar, v.y * scalar, v.z * scalar, v.w * scalar));
}
