...
/*   Updated: 2022/09/14 16:40:25 by minkyeki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "gl_vec3.h"

t_vec3	gl_get_vec3_from_3f(float _x, float _y, float _z)
{
	t_vec3	pos3;
...
t_vec3	gl_get_vec3_from_1f(float _k)
{
	return (gl_get_vec3_from_3f(_k, _k, _k));
}

t_vec3	gl_vec3_reverse(t_vec3 v)
{
	return (gl_get_vec3_from_3f(-v.x, -v.y, -v.z));
}

t_vec3	gl_vec3_add_vector(t_vec3 v1, t_vec3 v2)
{
	return (gl_get_vec3_from_3f(v1.x + v2.x, v1.y + v2.y, v1.z + v2.z));
}

t_vec3	gl_vec3_add_float(t_vec3 v, float f)
{
	return (gl_get_vec3_from_3f(v.x + f, v.y + f, v.z + f));
}
...
{
	return (gl_get_vec3_from_3f(v.x * scalar, v.y * scalar, v.z * scalar));
}
...
t_vec3	gl_vec3_clamp(t_vec3 v, t_vec3 min, t_vec3 max)
{
	...
	return (gl_get_vec3_from_3f(x, y, z));
}
...
t_vec3	gl_vec3_normalize(t_vec3 v)
{
	...
	return (gl_get_vec3_from_3f(v.x / len, v.y / len, v.z / len));
}
