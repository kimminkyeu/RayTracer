...
t_image *engine_new_image(t_device *device, t_vec2 img_size, t_vec2 img_location)
{
...
t_device	*engine_init(int _win_width, int _win_height, char *title, int resolution_ratio)
{
	t_device	*device;
	...
	// device->screen_image =
	device->screen_image = engine_new_image(device, gl_vec2_2f(_win_width, _win_height), gl_vec2_2f(0,0));
	device->pixel_image = engine_new_image(device, gl_vec2_2f(_win_width / resolution_ratio, _win_height / resolution_ratio), gl_vec2_2f(0,0));
...
t_image	*engine_new_xpm_image(t_device *device, char *filename, t_vec2 img_location)
{
	// t_vector *images = device->images;
	t_image	*new_image;
