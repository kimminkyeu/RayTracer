...
/*   Updated: 2022/09/14 16:35:47 by minkyeki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
extern t_vec4	gl_get_vec4_from_4f(float x_or_b, float y_or_g, float z_or_r, float w_or_a);

/* Create and Return R-value from single float argument.
- : functions sets every value to (float _k) */
extern t_vec4	gl_get_vec4_from_1f(float _k);
